...
func TestApi0LinkFormMap(t *testing.T) {
	...
	e := Entry{}
	assert.Equal(t, map[string]interface{}{"lf_description": "", "lf_linkdate": "00010101_000000", "lf_tags": "", "lf_title": ""}, e.api0LinkFormMap(), "oha")

	e = Entry{
		Title: HumanText{Body: "My #Post"},
	}
	assert.Equal(t, map[string]interface{}{"lf_description": "", "lf_linkdate": "00010101_000000", "lf_tags": "Post", "lf_title": "My #Post"}, e.api0LinkFormMap(), "oha")

	e = Entry{
		Title:      HumanText{Body: "My #Post"},
		Categories: []Category{{Term: "Post"}, {Term: "tag1"}},
	}
	assert.Equal(t, map[string]interface{}{"lf_description": "#tag1", "lf_linkdate": "00010101_000000", "lf_tags": "Post tag1", "lf_title": "My #Post"}, e.api0LinkFormMap(), "oha")
